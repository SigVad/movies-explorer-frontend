    ...
    <section className="about-me" id="about-me">
      ...
      <div className="about-me__content">
        <div className="about-me__content-info">
            ...
            Я родился и живу в Волгодонске, закончил факультет 
            информациоонй безопасности ТТИ ЮФУ. 
            У меня есть жена и дочь. Я люблю путешествовать и отдыхать с семьёй.
            Работаю в отделе разработки ПО - тестирую и оказываю 
            техподдержку.
            После того, как прошёл курс по веб-разработке, планирую стать одним из разработчиков своего отдела.
            </p>
